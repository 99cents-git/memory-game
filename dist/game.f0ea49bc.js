...
fetch("http://99dev.co.za/ls-22/c.json").then(function (response) {
  return response.json();
}).then(function (data) {
  generateGame(['mini-1.png', 'mini-2.png', 'mini-3.png', 'mini-4.png', 'mini-5.png', 'mini-6.png', 'mini-7.png', 'mini-8.png', 'mini-9.png', 'mini-10.png']);
